    ...
    <div className="mt-52 ">
      ...
      <div className=" grid grid-cols-3 gap-x-8 mx-20 mt-20 ">
        <div className=" absolute right-[230px] bottom-[-750px]">
          <img src="assets/background/element-1.svg" alt="element-1" />
        </div>
        <div className=" absolute left-0 bottom-[-900px]">
          <img src="assets/background/bg-1.svg" alt="bg-1" />
        </div>
        <Service
          key="1"
          title="Search doctor"
          logo="assets/service-icons/search-doctor.svg"
          description="Choose your doctor from thousands of specialist, general, and trusted hospitals"
        />
        <Service
          key="2"
          title="Online pharmacy"
          logo="assets/service-icons/online-pharmacy.svg"
          description="Buy your medicines with our mobile application with a simple delivery system"
        />
        <Service
          key="3"
          title="Consultation"
          logo="assets/service-icons/consultation.svg"
          description="Free consultation with our trusted doctors and get the best recomendations"
        />
        <Service
          key="4"
          title="Details info"
          logo="assets/service-icons/details-info.svg"
          description="Free consultation with our trusted doctors and get the best recomendations"
        />
        <Service
          key="5"
          title="Emergency care"
          logo="assets/service-icons/emergency-care.svg"
          description="You can get 24/7 urgent care for yourself or your children and your lovely family"
        />
        <Service
          key="6"
          title="Tracking"
          logo="assets/service-icons/tracking.svg"
